...
//     }
//     //create a task
//     function createTask(string memory _taskcontent,string memory _note, uint256 assetId, address signator) public {
//         taskCount++;
//         tasks[taskCount] = Task(taskCount, _taskcontent,_note,'', assetId, false, signator);
//     }
